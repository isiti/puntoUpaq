        ...
        <div class="login-body">
            ...
            <form action="" class="form-horizontal" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col btn-login">
                        <button class="btn" type="button" name="registrarse" value="Registrarse" data-toggle="modal"
                            data-target="#registro-modal">Registrarte</button>
                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-xs-12" style="float:right;">
                            <div class="logo_login">
                                <!-- <a href="https://www.nexosmart.com.ar/">
                                    <img src="<?="//$url_web/"?>assets/images/logos/logo-nexo-h.png" width="50%" alt="logo-nexosmart">
                                </a> -->
                            </div>
                        </div>
                    </div>
