        ...
        <div class="login-body">
            <div class="row title-login">
				...
				<div class="col-lg-6 col-md-6 col-xs-6 logo_inicio">
                    <img src="<?="//$url_web/"?>assets/images/logos/upaqLogo.png" alt="logo-login" width="50%">
				</div>
			</div>

            <div style="color:#fff;"><?php if($login) {foreach ($login as $values) { echo "<li>$values</li>"; } } ?></div>

            <form action="" class="form-horizontal" method="post">
                <div class="form-group">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <input name="email" class="form-control" type="text" value="<?=$_POST['email']?>" placeholder="email" required="required" />
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <input name="password" class="form-control" type="password" value="<?=$_POST['pw']?>" placeholder="password" required="required" />
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="row subtitle-login" style="margin-top: 2em;">
                        <div class="col-lg-6 col-md-6 col-xs-12" style="float:left;">                        
                            <!-- <a href="recovery" class="btn btn-link btn-block" style="font-size:0.8em;">¿No recuerda su contraseña??</a> -->
                            <p style="margin-left: 2em;">Un producto de </p>
                        </div>

                        <div class="col-lg-6 col-md-6 col-xs-12" style="float:right;">                        
                            <div class="logo_login">
                                <a href="https://www.nexosmart.com.ar/">
                                    <img src="<?="//$url_web/"?>assets/images/logos/logo-nexo-h.png" alt="logo-nexosmart">
                                </a>
                            </div>
                        </div>
                    </div>
